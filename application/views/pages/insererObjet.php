    ...
    <section class="register-photo">
        <div class="form-container">
            <form method="post" action="<?php echo base_url('objet/insert_objet'); ?>">
                <h2 class="text-center" style="font-size: 21px;"><strong>INSERER OBJET</strong><br><br><a href="#" style="font-size: 12px;height: 16px;padding: 7px;/*margin-top: -49px;*/margin: 12px;">Veulliez inserer les modificaton d'objet</a></h2>
                ...
                <button class="btn btn-primary btn-block" type="submit" style="background: rgb(81,94,110);">iNSERER</button>
            </form>
        </div>
        <a href="<?php echo base_url('accueil/usermenu'); ?>">Retour</a>        
    </section>
